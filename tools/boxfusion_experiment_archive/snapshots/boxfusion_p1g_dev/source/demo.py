...
if __name__ == "__main__":
    ...
    if dataset_path.lower() in ["scannet", "ca1m", 'online']:
        ...
        if p1_cli_requested:
            if (
                ...
                not in {
                    ...
                    "p1g_multiview_occupancy_msr_observer",
                ...
                parser.error(
                    ...
                    "a P1, P1R, P1S, P1G, P2, P2V2, or P2V3 "
                    "online-ablation profile"
                )
        ...
        if args.online_ablation_profile in {
            ...
            if p1_cfg.get("mode", "infer") == "collect":
                if (
                    ...
                    parser.error("P2/P2V2/P2V3 require P1 infer mode")
        ...
        if args.p2_occupancy_checkpoint is not None:
            if (
                ...
                parser.error(
                    ...
                    "a P2, P2V2, or P2V3 online-ablation profile"
                )
        ...
        if (
            ...
            parser.error(
                "P2/P2V2/P2V3 require --p2-occupancy-checkpoint"
            )
