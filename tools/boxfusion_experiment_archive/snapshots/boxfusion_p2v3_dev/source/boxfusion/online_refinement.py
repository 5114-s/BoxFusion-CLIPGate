...
def resolve_online_refinement_config(
    ...
    if p_stage not in {
        "DISABLED", "P0", "P1", "P2", "P2V2", "P2V3"
    }:
        raise ValueError(
            "p_ablation_stage must be disabled, P0, P1, P2, P2V2, "
            "or P2V3"
        )
    expected_p_profile = {
        "DISABLED": "disabled",
    ...
    if p1_enabled != (p_stage in {"P1", "P2", "P2V2", "P2V3"}):
        raise ValueError(
    ...
    if p1_enabled and resolved["ablation_profile"] != "quality_only":
        raise ValueError(
            "P1/P2/P2-v2/P2-v3 must be layered on the frozen "
