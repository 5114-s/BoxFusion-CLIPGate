...
> This isolated research checkout also contains the non-mutating P0/P1/P2
> residual-proposal and occupancy-Top-K ablation. Its training protocol,
> safety contract, commands, attribution, and stopping criteria are documented
> in [`docs/P_INCREMENTAL_ABLATION.md`](docs/P_INCREMENTAL_ABLATION.md).
> P1/P2 are observers and do not yet claim an AP gain.
