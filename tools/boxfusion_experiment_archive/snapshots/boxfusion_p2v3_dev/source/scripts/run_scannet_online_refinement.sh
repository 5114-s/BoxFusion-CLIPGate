...
if [[ "$ABLATION_PROFILE" == "p1_residual_proposal_observer" \
    ...
    echo "P1 residual options require a P1/P2/P2V2/P2V3 profile" >&2
    exit 1
fi
...
if [[ "$ABLATION_PROFILE" == "p0_frozen_b6" ]]; then
    ...
    echo "BOXFUSION_P_STAGE is valid only for a P0/P1/P2/P2V2/P2V3 profile" >&2
    exit 1
fi
