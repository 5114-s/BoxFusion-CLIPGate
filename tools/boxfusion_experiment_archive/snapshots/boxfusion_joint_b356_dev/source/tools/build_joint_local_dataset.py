...
def _load_strict_source(
    ...
    if not np.allclose(appearance, 0.5, atol=1e-7, rtol=0.0):
        raise ValueError(
    ...
    return arrays, _sha256_file(path)
...
def build_joint_local_dataset(
    ...
    source, source_sha256 = _load_strict_source(
