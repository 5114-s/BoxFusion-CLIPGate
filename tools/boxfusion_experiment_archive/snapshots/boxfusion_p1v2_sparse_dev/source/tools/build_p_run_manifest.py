...
def build_manifest(args: argparse.Namespace) -> dict:
    ...
    if (
        args.stage in {"P1", "P1R", "P1S", "P2", "P2V2", "P2V3"}
        and args.p1_checkpoint is None
    ):
        raise ValueError(
            "P1/P1R/P1S/P2/P2V2/P2V3 require a train-only P1 checkpoint"
        )
    ...
    if (
        ...
        raise ValueError(
            "P1/P1R/P1S/P2/P2V2/P2V3 require a canonical forbidden scene list"
        )
    required = {
    ...
    if args.stage in {"P1", "P1R", "P1S", "P2", "P2V2", "P2V3"}:
...
def _parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--stage",
        required=True,
        choices=("P0", "P1", "P1R", "P1S", "P2", "P2V2", "P2V3"),
    )
