...
def build_manifest(args: argparse.Namespace) -> dict:
    ...
    if args.stage in {"P1", "P2", "P2V2"} and args.p1_checkpoint is None:
        raise ValueError("P1/P2/P2V2 require a train-only P1 checkpoint")
    if args.stage in {"P2", "P2V2"} and p2_checkpoint is None:
        raise ValueError("P2/P2V2 require a train-only occupancy checkpoint")
    if args.stage not in {"P2", "P2V2"} and p2_checkpoint is not None:
        raise ValueError("Only P2/P2V2 may bind a P2 checkpoint")
    if (
        args.stage in {"P1", "P2", "P2V2"}
        and args.forbidden_scene_list is None
    ):
        raise ValueError(
            "P1/P2/P2V2 require a canonical forbidden scene list"
        )
    required = {
...
def _parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--stage", required=True, choices=("P0", "P1", "P2", "P2V2")
    )
