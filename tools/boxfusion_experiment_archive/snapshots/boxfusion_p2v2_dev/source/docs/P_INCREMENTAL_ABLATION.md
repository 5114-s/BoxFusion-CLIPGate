# BoxFusion P 路线：P2V2 Local Mask-RGBD Geometry Observer
...
```bash
cd /data/ZhaoX/OVM3D-Dett/boxfusion_p2v2_dev
...
每次 P0/P1/P2/P2V2 启动都会在对应 log 目录写入不可变
