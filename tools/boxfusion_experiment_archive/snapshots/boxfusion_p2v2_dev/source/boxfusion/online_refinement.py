...
def resolve_online_refinement_config(
    ...
    if p_stage not in {"DISABLED", "P0", "P1", "P2", "P2V2"}:
        raise ValueError(
            "p_ablation_stage must be disabled, P0, P1, P2, or P2V2"
        )
    expected_p_profile = {
        "DISABLED": "disabled",
        "P0": "p0_frozen_b6",
    ...
    if p1_enabled and resolved["ablation_profile"] != "quality_only":
        raise ValueError(
            "P1/P2/P2-v2 must be layered on the frozen quality_only B6 "
            "profile"
        )
    if not isinstance(
