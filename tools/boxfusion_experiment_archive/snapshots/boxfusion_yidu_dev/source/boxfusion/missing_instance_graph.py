...
class MissingInstanceGraphObserver:
    ...
    def candidate_decisions(
        ...
        """Return the current readout decisions without mutating lifecycle.

        This is the diagnostic counterpart of :meth:`candidates`.  It uses
        the same materialization and global-overlap guard, but exposes every
        active or archived track, including tracks rejected at final readout.
        """
