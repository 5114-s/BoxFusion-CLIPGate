...
def build(args: argparse.Namespace) -> Dict[str, object]:
    ...
    payload: Dict[str, object] = {
        "schema": "boxfusion.yidu.run_manifest.v2",
        "stage": args.stage,
        ...
        "teacher_cache": os.fspath(teacher_cache),
        "teacher_namespace": args.teacher_namespace,
        "teacher_metadata_sha256": cache_metadata_hash(teacher_cache),
        "cache_missing_policy": args.cache_missing_policy,
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--teacher-namespace", required=True)
