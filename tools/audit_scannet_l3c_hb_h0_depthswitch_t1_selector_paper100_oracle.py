#!/usr/bin/env python3
"""Run the fixed-geometry paper100 oracle for sealed L3C depth switches."""
...
from tools.run_scannet_l3c_hb_h0_depthswitch_t1_selector_paper100 import (  # noqa: E402
    PROTOCOL_ID,
    SCHEMA as SHADOW_SCHEMA,
)


SCHEMA = "boxfusion.scannet_l3c_hb_h0_depthswitch_t1_selector_paper100_oracle.v1"
DEFAULT_SHADOW = ROOT / "logs/scannet_l3c_hb_h0_depthswitch_t1_selector_paper100_score05/final/L3C_HB_H0_DEPTHSWITCH_T1_SELECTOR_PAPER100.json"
DEFAULT_OUT = ROOT / "reports/l3c_hb_h0_depthswitch_t1_selector_paper100_oracle/L3C_HB_H0_DEPTHSWITCH_T1_SELECTOR_PAPER100_ORACLE.json"
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.out.exists() or args.out.is_symlink():
        raise L3OracleError(f"refusing to overwrite L3C oracle: {args.out}")
    report = audit(
    ...
    report["decision"]["next_step"] = (
        ...
        if gate
        else "discard_L3C_depthswitch_geometry_selector_for_plus10_route"
    )
