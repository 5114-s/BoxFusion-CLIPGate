...
PARENT_ROOT="${BOXFUSION_C1_PARENT_CACHE_ROOT:-$R2_ROOT/cache/tr3d_prefix_boxfusion_causal_p100_fixed10_v2}"
R2A_ROOT="${BOXFUSION_C1_R2A_CACHE_ROOT:-$R2_ROOT/cache/tr3d_r2a/r2a_depth_fixed10_v3}"
R2B_ROOT="${BOXFUSION_C1_R2B_CACHE_ROOT:-$R2_ROOT/cache/tr3d_r2b/r2b_dino_fixed10_v1}"
R2A_REPORT="${BOXFUSION_C1_R2A_EXPORT_REPORT:-$R2_ROOT/reports/tr3d_r2a/r2a_depth_fixed10_v3/export_report.json}"
R2B_REPORT="${BOXFUSION_C1_R2B_EXPORT_REPORT:-$R2_ROOT/reports/tr3d_r2b/r2b_dino_fixed10_v1/export_report.json}"
SCENE_LIST="${BOXFUSION_C1_SCENE_LIST:-$ROOT/evaluation/data_util/meta_data/scannetv2_val_ablation10_even.txt}"
...
ACTIVE_ROOT="${BOXFUSION_C1_ACTIVE_ROOT:-/extra/ZhaoX/codex_artifacts/boxfusion_r3_20260805/boxfusion_tr3d_terminal_paired_fixed10/results/b6_g0_tr3d_terminal/g0_tr3d_terminal_paired_fixed10_v1/scannetv2_val_ablation10_even-0b45515fe11a}"
...
[[ "$scene_count" == "10" ]] || { echo "C1 fixed10 requires exactly 10 scenes" >&2; exit 2; }
[[ ! -e "$RUN_ROOT" ]] || { echo "Refusing immutable run overwrite: $RUN_ROOT" >&2; exit 2; }
mkdir -p "$CACHE_ROOT" "$REPORT_ROOT"

echo "C1 unmatched TR3D multi-view evidence-track observer"
echo "  frozen anchor: R3 active"
echo "  scenes: 10 from $SCENE_LIST"
...
echo "  disclosure: cross-view evidence only; cross-prefix tracking=false"
...
echo "C1 fixed10 complete: $REPORT_ROOT/gt_audit.json"
