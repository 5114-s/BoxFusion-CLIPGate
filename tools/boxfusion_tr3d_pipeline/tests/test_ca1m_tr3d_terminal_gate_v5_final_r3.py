...
from boxfusion import ca1m_tr3d_terminal_gate_v5_final_r3 as final


ROOT = Path(__file__).resolve().parents[1]
PREFLIGHT = ROOT / "tools/preflight_ca1m_tr3d_terminal_gate_v5_final_r3.py"
...
def _synthetic_r6(
    ...
    # final-R3 FUSE writer so both interpreter runs exercise real I/O.
...
def test_static_protocol_builder_does_not_open_scene_gt(
    ...
    assert payload["invalidated_predecessor"]["sha256"] == (
        final.R2_PROTOCOL_INVALID_SHA256
    )
