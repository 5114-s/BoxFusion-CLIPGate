...
OUT = os.environ.get("CAUSAL_OUT", "/data/ZhaoX/BoxFusion/results/causal_m1m2_v2")
os.makedirs(OUT, exist_ok=True)

DEDUP = float(os.environ.get('CAUSAL_DEDUP', '0.25'))
CAP = int(os.environ.get('CAUSAL_CAP', '12'))
TTL = 10
SELF_NMS = 0.50
ALPHA = float(os.environ.get('CAUSAL_ALPHA', '0.6'))
