...
EXPERIMENT=scannet_cbest_real_score_c2_native_first_low_score_append_score05
OUTPUT_ROOT="$ROOT/results/$EXPERIMENT"
LOG_ROOT="$ROOT/logs/$EXPERIMENT"
MATERIALIZER="$ROOT/tools/materialize_scannet_c2_native_first_low_score_append_full100.py"
